...
public class HibernateGlobals
{
    ...
    /**
     * Namespace property informando se as entidades devem receber auditoria
     */
    static final String HIBERNATE_ENTITY_AUDITORIA = "hibernateEntityAuditoria";
    /**
     * Namespace property informando o tamanho máximo das Strings que representam
     * as referências na tabela de auditoria
     */
    static final String TAMANHO_ASSOCIACAO = "tamanhoAssociacao";
