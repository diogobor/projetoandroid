...
/*
Essa fun?o basicamente altera o  backspace nos input com m?cara reais para os navegadores IE e opera.
O IE n? detecta o keycode 8 no evento keypress, por isso, tratamos no keydown.
Como o opera suporta o infame document.all, tratamos dele na mesma parte do c?igo.
*/
...
if (whichCode == 8 && documentall) {	
	...
	obj.value =""; //necess?io para o opera
	obj.value += y;
...
function limpaStringParaMoney(element) {
