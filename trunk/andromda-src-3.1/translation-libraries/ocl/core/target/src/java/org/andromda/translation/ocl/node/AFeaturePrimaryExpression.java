...
public final class AFeaturePrimaryExpression extends PPrimaryExpression
{
    ...
    public Object clone()
    {
        return new AFeaturePrimaryExpression(
    ...
    {
        ((Analysis) sw).caseAFeaturePrimaryExpression(this);
    }
