...
public final class AMultiplicativeExpression extends PMultiplicativeExpression
{
        ...
        List _multiplicativeExpressionTail_)
    {
...

        {
            ...
            this._multiplicativeExpressionTail_.addAll(_multiplicativeExpressionTail_);
        }
    ...
    {
        _multiplicativeExpressionTail_.clear();
        _multiplicativeExpressionTail_.addAll(list);
    }
