    ...
    extends BasePlugin
{
    ...
    {
        AndroMDALogger.info("\n\nGerando todos os arquivos . Aguarde um momento!\n\n");
        ...
        final String metafacadePackage)
    {
        ...
        try
        {
            ...
            {
            	/* ==================================================================
            	   [Moises-COPPETEC] Codigo para gerar um log das classes que excedem um certo valor
                   ================================================================== */
            	
            	try{
            		int maxSizeClass = Integer.parseInt((String)templateContext.get("maxSizeClass"));
            		
            		if((metafacadePackage.length() + metafacadeName.length()) > maxSizeClass){
            			log.debug(outputFile.getPath());
            		}
            	}catch (NumberFormatException e) {
            		this.getLogger().error("Propriedade maxSizeClass deve ser um inteiro");
				}
            	catch (Exception e) {
					this.getLogger().error("Propriedade maxSizeClass não configurada");
				}
